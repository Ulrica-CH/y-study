    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          {
            text: "思想",
            link: "/engineering/micro-kernel/index",
          ...
          {
            text: "规范化",
            link: "/engineering/eslint/index",
            // items: [
            //   { text: "EsLint", link: "/engineering/eslint/index" },
            //   { text: "Prettier", link: "/engineering/prettier/index" },
            //   { text: "Stylelint", link: "/engineering/stylelint/index" },
            //   { text: "Husky", link: "/engineering/husky/index" },
            //   { text: "Cspell", link: "/engineering/cspell/index" },
      ...
      "/engineering/": [
        ...
        { text: "构建工具", link: "/engineering/build-tools" },
        {
          ...
          items: [
            ...
            {
              text: "浏览器性能优化实战",
              link: "/engineering/performance/web-performance/hand",
            },
